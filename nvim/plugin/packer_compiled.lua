...
_G.packer_plugins = {
  ...
  ["mason-null-ls.nvim"] = {
    loaded = true,
    path = "/Users/apple/.local/share/nvim/site/pack/packer/start/mason-null-ls.nvim",
  ...
  ["vim-nightfly-guicolors"] = {
    loaded = true,
    path = "/Users/apple/.local/share/nvim/site/pack/packer/start/vim-nightfly-guicolors",
